...
class Frame(object):
    ...
    def __init__(self, idx, pose, feature, cam, timestamp=None,
        ...
        # TODO: think about a way to set id of each frame
        self.id = 0
        ...
        # Features, the most important part is keypoints and descriptor
...
class KeyFrame(MonoFrame, StereoCamera, RGBDFrame):
    pass
